  ...
  try {
    ...
    await pool.query(`
      ...
      BEGIN
        ...
        -- FK Constraint Patches (for existing tables)
        BEGIN
        ...
        EXCEPTION WHEN duplicate_object THEN END;
        BEGIN
          ALTER TABLE customers ADD CONSTRAINT customers_customer_type_id_fkey FOREIGN KEY (customer_type_id) REFERENCES customer_types(id);
        EXCEPTION WHEN duplicate_object THEN END;
      END $$;
    `);
