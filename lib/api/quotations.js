...
export async function getQuotations(searchParams) {
    try {
        ...
        await query(`ALTER TABLE quotation_items ADD COLUMN IF NOT EXISTS recommended_price NUMERIC DEFAULT 0;`);
...
export async function getQuotationById(id, adminId = null) {
    try {
        ...
        const itemsRes = await query(`
            ...
            p.dealer_price as current_dealer_price, p.mrp_price as current_mrp, 
            p.recommended_price as current_recommended, p.images, 
        ...
        for (const item of items) {
            ...
            await query(
                `INSERT INTO quotation_items (
                    ...
                    total_price, line_total, mrp, dealer_price, recommended_price, discount, slug, is_detailed,
