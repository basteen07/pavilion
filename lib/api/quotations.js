...
export async function getQuotationById(id, adminId = null) {
    try {
        ...
        const itemsRes = await query(`
            SELECT qi.*, p.dealer_price as current_dealer_price, p.mrp_price as current_mrp, p.images, p.short_description
        ...
        // Log view activity if adminId is present
        if (adminId) {
            try {
        ...
        for (const item of items) {
            await query(
                `INSERT INTO quotation_items (
                    ...
                    short_description, image_url, category_name, sub_category_name, brand_name
                )
