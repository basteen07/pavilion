    ...
    try {
        ...
        const result = await query(
            `UPDATE product_variants SET
                ...
                mrp_updated_at = CASE WHEN $10::numeric IS NOT NULL AND $10::numeric != mrp_price THEN CURRENT_TIMESTAMP ELSE mrp_updated_at END,
                dealer_price_updated_at = CASE WHEN $11::numeric IS NOT NULL AND $11::numeric != dealer_price THEN CURRENT_TIMESTAMP ELSE dealer_price_updated_at END,
                counter_price_updated_at = CASE WHEN $12::numeric IS NOT NULL AND $12::numeric != counter_price THEN CURRENT_TIMESTAMP ELSE counter_price_updated_at END,
                recommended_price_updated_at = CASE WHEN $13::numeric IS NOT NULL AND $13::numeric != recommended_price THEN CURRENT_TIMESTAMP ELSE recommended_price_updated_at END,
                shop_price_updated_at = CASE WHEN $14::numeric IS NOT NULL AND $14::numeric != shop_price THEN CURRENT_TIMESTAMP ELSE shop_price_updated_at END,
                    ...
                    if (existingVariant.rows.length > 0) {
                        ...
                        await query(
                            `UPDATE product_variants SET
                                ...
                                is_default = $15,
                                mrp_updated_at = CASE WHEN ($9 IS NOT NULL AND $9 != mrp_price) THEN CURRENT_TIMESTAMP ELSE mrp_updated_at END,
                                dealer_price_updated_at = CASE WHEN ($10 IS NOT NULL AND $10 != dealer_price) THEN CURRENT_TIMESTAMP ELSE dealer_price_updated_at END,
                                counter_price_updated_at = CASE WHEN ($11 IS NOT NULL AND $11 != counter_price) THEN CURRENT_TIMESTAMP ELSE counter_price_updated_at END,
                                recommended_price_updated_at = CASE WHEN ($12 IS NOT NULL AND $12 != recommended_price) THEN CURRENT_TIMESTAMP ELSE recommended_price_updated_at END,
                                shop_price_updated_at = CASE WHEN ($13 IS NOT NULL AND $13 != shop_price) THEN CURRENT_TIMESTAMP ELSE shop_price_updated_at END,
                                updated_at = CURRENT_TIMESTAMP
                            WHERE sku = $2`,
                            [
